...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentPetUri == null){
            setTitle(getString(R.string.editor_activity_title_add_a_pet));
            // Invalidate the options menu, so the "Delete" menu option can be hidden.
            // It does not make sense to delete a pet that hasn't been created yet.
    ...
    public boolean onPrepareOptionsMenu(Menu menu){
        ...
        // If there is a new pet, hide the "Delete" menu item.
        if (mCurrentPetUri == null){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                // If the pet has not changed, continue with navigating up to parent activity
